...
const (
	...
	DBaaSInventoryCredentialsNotFound string = "InventoryCredentialsNotFound"
	...
	MsgInventoryCredentialsNotFound  string = "Could not find credentials for the inventory"

	TypeLabelValue     = "credentials"
	TypeLabelKey       = "db-operator/type"
	TypeLabelKeyMongo  = "atlas.mongodb.com/type"
	DependencyCheckKey = "db-operator/dependencycheckskip"
